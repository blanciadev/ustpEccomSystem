...
const AddProductModal = ({ show, handleClose, handleSubmit }) => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_SERVER_LINK}/api/product-category`);
                if (!response.ok) {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_SERVER_LINK}/api/add-product`, {
                method: "POST",
                headers: {

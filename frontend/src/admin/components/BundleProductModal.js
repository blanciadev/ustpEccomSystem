  ...
  const fetchProducts = async () => {
    ...
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_SERVER_LINK}/api/products-no-bundle`
      );
            ...
            <div className="modal-content">
              <div className="modal-header order-head">
                <h5 className="modal-title">
                  <i className="bx bxs-package"></i> Add Product Discounts
                </h5>
                <button
                  type="button"
                  className="close"
                        ...
                        <div>
                          <div>
                            ...
                            >
                              ...
                              <option value="1">Hair Spa</option>
                              <option value="2">Absolut Repair</option>
                              <option value="3">Absolut Repair Molecular</option>

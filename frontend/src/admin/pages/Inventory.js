...
const Inventory = () => {
  ...
  //   try {
  //     const response = await axios.get(`${process.env.REACT_APP_SERVER_LINK}/api/admin-inventory");
  ...
  const ExportButton = () => {
    const handleExport = () => {
      const url = `${process.env.REACT_APP_SERVER_LINK}/api/admin-products-inventory?export=excel`;

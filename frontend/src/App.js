...
import { Route, Routes, Navigate, useLocation } from 'react-router-dom'; // No Router here, just Routes
...
function App() {
  const location = useLocation(); // This still works as it's within the Router context
